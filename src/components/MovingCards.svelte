...
>
  ...
  >
    {#each items as item, idx (item.name)}
      <li
        class="relative w-[350px] max-w-full flex-shrink-0 rounded-2xl text-justify border border-b-0 border-slate-700 px-8 py-6 md:w-[450px]"
      ...
      >
        <blockquote>
          ...
          <div class="relative z-20 mt-6 flex flex-row items-center font-anta">
